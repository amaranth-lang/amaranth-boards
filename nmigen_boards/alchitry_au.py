...
def find_loader():
    import shutil # Delay this until we're actually trying to program
...
class AlchitryAuPlatform(Xilinx7SeriesPlatform):
    ...
    connectors  = [
        ...
        # There's a bunch of non-io lines in bank 4. Might need a better way to represent this
