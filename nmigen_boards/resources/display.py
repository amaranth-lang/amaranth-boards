...
def VGAResource(*args, r, g, b, vsync, hsync, invert_sync=False, conn=None, attrs=None):
    ios = []
    ...
    ios.append(Subsignal("hsync", Pins(hsync, dir="o", invert=invert_sync, conn=conn, assert_width=1)))
    ios.append(Subsignal("vsync", Pins(vsync, dir="o", invert=invert_sync, conn=conn, assert_width=1)))
