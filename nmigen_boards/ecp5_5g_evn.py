...
class ECP55GEVNPlatform(LatticeECP5Platform):
    ...
    def __init__(self, *, VCCIO1="LVCMOS25", VCCIO2="LVCMOS33", VCCIO6="LVCMOS33", VCCIO7="LVCMOS33", **kwargs):
        assert VCCIO1 in ["LVCMOS33", "LVCMOS25"]
        assert VCCIO2 in ["LVCMOS33", "LVCMOS25"]
        assert VCCIO6 in ["LVCMOS33", "LVCMOS25"]
        assert VCCIO7 in ["LVCMOS33", "LVCMOS25", "LVCMOS15", "LVCMOS12"]
        self._VCCIO1 = VCCIO1
        self._VCCIO2 = VCCIO2
        self._VCCIO6 = VCCIO6
        self._VCCIO7 = VCCIO7
    ...
    resources   = [
        ...
        *LEDResources(pins="A13 A12 B19 A18 B18 C17 A17 B17", invert=True,
                      attrs=Attrs(IO_TYPE=VCCIO1)),
        
        *ButtonResources(pins="P4", invert=True,
                         attrs=Attrs(IO_TYPE=VCCIO6)),
        ...
        *SwitchResources(pins={4: "E15", 5: "D16", 6: "B16", 7: "C16", 8: "A16"}, invert=True,
        ...
        # Resource("diff", "1", DiffPairs(B5, C5), Attrs(IO_TYPE=VCCIO7)),
        # Resource("diff", "2", DiffPairs(C4, B4), Attrs(IO_TYPE=VCCIO7)),
        # Resource("diff", "3", DiffPairs(A3, B3), Attrs(IO_TYPE=VCCIO7)),
        # Resource("diff", "4", DiffPairs(E4, D5), Attrs(IO_TYPE=VCCIO7)),
        # Resource("diff", "5", DiffPairs(C3, D3), Attrs(IO_TYPE=VCCIO7)),
        # Resource("diff", "6", DiffPairs(F4, E3), Attrs(IO_TYPE=VCCIO7)),
        # Resource("diff", "7", DiffPairs(E5, F5), Attrs(IO_TYPE=VCCIO7)),
        # Resource("diff", "8", DiffPairs(A2, B1), Attrs(IO_TYPE=VCCIO7)),
        # Resource("diff", "9", DiffPairs(B2, C2), Attrs(IO_TYPE=VCCIO7)),
        # Resource("diff", "10", DiffPairs(C1, D1), Attrs(IO_TYPE=VCCIO7)),
        # Resource("diff", "11", DiffPairs(D2, E1), Attrs(IO_TYPE=VCCIO7)),
        # Resource("diff", "12", DiffPairs(H4, G5), Attrs(IO_TYPE=VCCIO7)),
        # Resource("diff", "13", DiffPairs(H5, H3), Attrs(IO_TYPE=VCCIO7)),
        # Resource("diff", "14", DiffPairs(G3, F3), Attrs(IO_TYPE=VCCIO7)),
        # Resource("diff", "15", DiffPairs(F2, E2), Attrs(IO_TYPE=VCCIO7)),
        # Resource("diff", "16", DiffPairs(G19, H20, Attrs(IO_TYPE=VCCIO2)),
        # Resource("diff", "17", DiffPairs(J18, K18, Attrs(IO_TYPE=VCCIO2)),
        # Resource("diff", "18", DiffPairs(J19, K19, Attrs(IO_TYPE=VCCIO2)),
        # Resource("diff", "19", DiffPairs(J20, K20, Attrs(IO_TYPE=VCCIO2)),
