...
class Colorlight_5A75B_R80Platform(LatticeECP5Platform):
    ...
    resources = [
        ...
        *ButtonResources(pins="R7", invert = True,
        ...
        # 1x ESMT M12L64322A-5T 2M 200MHz SDRAM (organized as 2M x 32bit)
        SDRAMResource(0,
            clk="C8", we_n="B5", cas_n="A6", ras_n="B6",
            ba="B7 A8", a="A9 B9 B10 C10 D9 C9 E9 D8 E8 C7",
        ...
        # Realtek RTL8211FD Gigabit Ethernet Transceiver
